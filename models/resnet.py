# ---------------------------------------------------------------------------------------------------------------
# Modified from PyTorch-Resnet (https://pytorch.org/docs/stable/_modules/torchvision/models/resnet.html#resnet18)
# ---------------------------------------------------------------------------------------------------------------
import paddle
...
def conv3x3(in_planes, out_planes, stride=1, groups=1, dilation=1):
    ...
    return dg.Conv2D(in_planes, out_planes, filter_size=3, stride=stride, 
                     padding=dilation, dilation=dilation, groups=groups, bias_attr=False)


def conv1x1(in_planes, out_planes, stride=1):
    """1x1 convolution"""
    return dg.Conv2D(in_planes, out_planes, filter_size=1, stride=stride, bias_attr=False)
